...
// Note: no comments on purpose - read the signatures to figure out how to use
// this class!
...
public class InputDataFile
{
	...
	/**
	 * This method reads a string and returns null if it doesn't work (for instance,
